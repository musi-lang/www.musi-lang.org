---
title: "Attributes"
description: "Use attributes to attach extra data for known by the compiler items, layout, native links, error messages, and lifecycle information."
...
---
Attributes attach extra information to named parts. They are useful when tools, generated code, native edges, or known built-ins need extra data that is not part of the normal value expression.
