---
title: "Forall Types"
description: "Read clear universal type forms without turning them into everyday ceremony."
group: "Types"
section: "Types"
order: 22
slug: "forall-types"
...
---
`forall` types describe code that works for every type matching the form. They are the type-level version of saying, “I do not care what is in the box; I only promise to handle the box consistently.”
...
## Read the quantifier as an edge
