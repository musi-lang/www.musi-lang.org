...
- [Traits, Classes, Instances, and Laws](/learn/guides/rust/traits-classes-laws) - behaviors stop hiding in object habits.
...
Musi `class` is closest to a Rust trait plus law text. Instances give behavior. If you need a person, car, invoice, or package, start with records or data. If you need any type that can compare, show, encode, or step, use a class with instances.
