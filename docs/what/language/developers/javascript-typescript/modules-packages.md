...
Do not rebuild an old global namespace, header include pile, or barrel file when one import names the owner. In JavaScript and TypeScript, this appears often in modules, packages, and imports.
