...
Do not keep integer tags, string unions, subshape checks, or table marker fields when a data variant is the real form. In Python, this appears often in data variants and pattern matching.
