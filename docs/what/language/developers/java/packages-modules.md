...
Do not rebuild an old global namespace, header include pile, or barrel file when one import names the owner. In Java, this appears often in packages and modules.
