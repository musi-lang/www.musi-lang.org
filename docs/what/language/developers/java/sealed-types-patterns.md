...
Do not keep integer tags, string unions, subshape checks, or table marker fields when a data variant is the real form. In Java, this appears often in sealed types and patterns.
