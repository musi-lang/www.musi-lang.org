...
Do not write a test that only proves syntax can be called. Make the receipt, route, badge, or parser claim visible. In Go, this appears often in testing and tools.
