...
Do not treat class as stored object data from Go while reading structs, records, and field updates. Start with records or variants for data. In Go, this appears often in structs, records, and field updates.
