...
export const bookParts = [
	...
	},
	{
		...
		sourcePath: "src/content/book/language/effects-runtime/index.md",
	},
	{
		id: "developers",
		path: "/docs/guides",
		...
		sourcePath: "src/content/book/language/developers/index.md",
	},
	{
		id: "advanced",
		path: "/docs/book/advanced",
		aliases: ["/docs/language/advanced", "/learn/language/advanced"],
		sourcePath: "src/content/book/language/advanced/index.md",
	},
