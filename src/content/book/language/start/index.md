...
order: 1
slug: "start"
summary: "Begin with setup, one file, one binding model, one expression model, then clear mutation."
---

The Start part is the front door of Musi Book. It does not try to teach every feature at once. It teaches the first reading habit: a file contains named parts, and each part gives the next reader a stable thing to talk about.
